...
class SampleContactsAdapter extends CursorAdapter {
  ...
  @Override public void bindView(View view, Context context, Cursor cursor) {
    Uri contactUri = Contacts.getLookupUri(cursor.getLong(SampleContactsActivity.ContactsQuery.ID),
        cursor.getString(SampleContactsActivity.ContactsQuery.LOOKUP_KEY));

    ViewHolder holder = (ViewHolder) view.getTag();
    holder.text1.setText(cursor.getString(SampleContactsActivity.ContactsQuery.DISPLAY_NAME));
